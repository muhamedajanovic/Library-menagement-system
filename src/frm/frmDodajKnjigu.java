 ...
 * @author muham
 */
public class frmDodajKnjigu extends javax.swing.JFrame {
    ...
    private void btnDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDodajActionPerformed
        ...
        if(validacijaUnosa(ime, autor, kolicina)){
            ...
            while(rs.next()){
                ...
                ps = kon.prepareStatement("INSERT INTO knjige (ime, autor, kategorija, kolicina) VALUES (?,?,?,?)");
                ps.setString(1, ime);
                ps.setString(2, autor);
                ps.setString(3, kategorija);
                ps.setString(4, kolicina);
                ps.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDodajKnjigu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
